...
class searchenginedbHelper(mySqlHelper):
    ...
    def selectOne(self, prames):
        sql = "select * from searchengine where keyword = %s and name = %s"
    ...
    def insert(self, prames):
        ...
        sql = "insert into searchengine (id, name, keyword, searchnums, searchtime)  values (%s, %s, %s, %s, %s)"
    ...
    def updateSearchtime(self, prames):
        ...
        sql = "update searchengine set searchtime=%s where keyword=%s and name = %s"
        mySqlHelper.update(self, sql, prames)
        pass

    def updateSearchnums(self, prames):
        sql = "update searchengine set searchnums=%s where keyword=%s and name = %s"
        mySqlHelper.update(self, sql, prames)
        pass
